...
public class Flood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainimage = (ImageView) findViewById(R.id.flood_mainimage);
        defination = (TextView) findViewById(R.id.floodDefination);


        tip1 = (TextView)findViewById(R.id.floodtip1);
        tip2 = (TextView)findViewById(R.id.floodtip2);
        tip3 = (TextView)findViewById(R.id.floodtip3);
        tip4 = (TextView)findViewById(R.id.floodtip4);
        tip5 = (TextView)findViewById(R.id.floodtip5);
        tip6 = (TextView)findViewById(R.id.floodtip6);
        tip7 = (TextView)findViewById(R.id.floodtip7);
        tip8 = (TextView)findViewById(R.id.floodtip8);
        tip9 = (TextView)findViewById(R.id.floodtip9);
        tip10 = (TextView)findViewById(R.id.floodtip10);


        image1 = (ImageView) findViewById(R.id.flood_image1);
        image2= (ImageView)findViewById(R.id.flood_image2);
        image3 = (ImageView)findViewById(R.id.flood_image3);
        image4 = (ImageView)findViewById(R.id.flood_image4);
        image5 = (ImageView)findViewById(R.id.flood_image5);
        image6 = (ImageView)findViewById(R.id.flood_image6);
        image7 = (ImageView)findViewById(R.id.flood_image7);
        image8 = (ImageView)findViewById(R.id.flood_image8);
        image9 = (ImageView)findViewById(R.id.flood_image9);
        image10 = (ImageView)findViewById(R.id.flood_image10);



        firebaseDatabase = FirebaseDatabase.getInstance().getReference().child("Flood");
