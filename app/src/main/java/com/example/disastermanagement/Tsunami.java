...
public class Tsunami extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainimage = (ImageView) findViewById(R.id.tsunami_mainimage);
        defination = (TextView) findViewById(R.id.tsunamiDefination);

        tip1 = (TextView)findViewById(R.id.tsunamitip1);
        tip2 = (TextView)findViewById(R.id.tsunamitip2);
        tip3 = (TextView)findViewById(R.id.tsunamitip3);
        tip4 = (TextView)findViewById(R.id.tsunamitip4);
        tip5 = (TextView)findViewById(R.id.tsunamitip5);
        tip6 = (TextView)findViewById(R.id.tsunamitip6);
        tip7 = (TextView)findViewById(R.id.tsunamitip7);
        tip8 = (TextView)findViewById(R.id.tsunamitip8);
        tip9 = (TextView)findViewById(R.id.tsunamitip9);
        tip10 = (TextView)findViewById(R.id.tsunamitip10);


        image1 = (ImageView) findViewById(R.id.tsunami_image1);
        image2= (ImageView)findViewById(R.id.tsunami_image2);
        image3 = (ImageView)findViewById(R.id.tsunami_image3);
        image4 = (ImageView)findViewById(R.id.tsunami_image4);
        image5 = (ImageView)findViewById(R.id.tsunami_image5);
        image6 = (ImageView)findViewById(R.id.tsunami_image6);
        image7 = (ImageView)findViewById(R.id.tsunami_image7);
        image8 = (ImageView)findViewById(R.id.tsunami_image8);
        image9 = (ImageView)findViewById(R.id.tsunami_image9);
        image10 = (ImageView)findViewById(R.id.tsunami_image10);



        firebaseDatabase = FirebaseDatabase.getInstance().getReference().child("Tsunami");
